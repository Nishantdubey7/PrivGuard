...
import { imageRedactionLevels } from "@/lib/constants/sections";
    ...
    <Card className="bg-white/[0.02] border-white/5 backdrop-blur-sm mb-8">
      <CardHeader>
        <CardTitle className="text-2xl text-white flex items-center gap-3">
          ...
          Image File Redaction
        </CardTitle>
        <CardDescription className="text-gray-400">
          Upload an image file and select the redaction method
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-8">
        ...
        <div>
          ...
          <div className="relative">
            <input
              type="file"
              accept=".jpg,.jpeg,.png,application/jpg"
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge className={`${imageRedactionLevels[redactionLevel[0]].color} bg-white/5 border-0`}>
              {imageRedactionLevels[redactionLevel[0]].label}
            </Badge>
          </div>
          ...
          <div className="text-sm text-gray-400 mt-3 bg-white/[0.02] p-4 rounded-lg border border-white/5 space-y-2">
            ...
            <p>
              {imageRedactionLevels[redactionLevel[0]].description}
            </p>
          </div>
        </div>
