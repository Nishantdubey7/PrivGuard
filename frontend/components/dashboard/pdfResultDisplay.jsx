...
export default function PdfResultsDisplay({ result, file, onReset }) {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = file?.name?.replace(".pdf", "_redacted.pdf") || "redacted.pdf";
        ...
        <CardContent>
          <div className="bg-black/30 rounded-xl border border-white/5 overflow-hidden">
            ...
            >
              {result.pdfUrl && (
                <iframe
                  src={`${result.pdfUrl}#toolbar=0&navpanes=0&scrollbar=0`}
